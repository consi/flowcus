        ...
        sections: vec![
            ...
            SectionDescriptor {
                ...
                fields: vec![
                    ...
                    SettingDescriptor {
                        section: "storage",
                        key: "cache_preheat_on_startup",
                        label: "Pre-heat Cache on Startup",
                        description: "Load bloom filters and marks from sealed hours into the cache when the application starts.",
                        guidance: "Loads oldest-first so LRU naturally keeps recent data. May increase startup I/O.",
                        control: ControlType::Bool,
                        default_value: dj["storage"]["cache_preheat_on_startup"].clone(),
                        restart_required: true,
                    },
                    SettingDescriptor {
                        section: "storage",
                        key: "cache_preheat_on_seal",
                        label: "Pre-heat Cache on Seal",
                        description: "Proactively load bloom filters and marks into cache when the merge system seals an hour.",
                        guidance: "Warms the cache for freshly merged parts, reducing first-query latency for recent data.",
                        control: ControlType::Bool,
                        default_value: dj["storage"]["cache_preheat_on_seal"].clone(),
                        restart_required: true,
                    },
                ],
            },
